...
export class UpdateTransactionFormsComponent implements OnInit {
  ...
  public showSampleConfirmButton: boolean=false;
  ...
  checkStatus() {
    ...
    if (this.checkLoginStatus != 'true') {
      ...
      this.showSampleConfirmButton = true;
    ...
    } else if(this.everything.transactionStatus === 'Quotation / Dispatch' &&
    localStorage.getItem('token') === 'Sample Head2')
    {
      this.stateBasedReadOnly = true;
      this.everythingReadOnly = true;
      ...
      this.showSaveWithoutRegexButton = true;
      this.showQuotationDispatch = false;
      this.showDownloadAsPDFButton = true;
      this.showConfirmButton = false;
      this.showSaveButton = false;
      // this.showAcceptButton = false;
      ...
      this.showSampleConfirmButton = false;
      this.showSendForCustomerAcceptanceButton=true;
      ...
      this.showAcceptButton = true;
      this.showSendForCustomerAcceptanceButton = false;
      this.showQuotationFormList = false;
      this.showArtWorkFileName = false;
  ...
  ngOnInit() {
    ...
    if (
      ...
      this.accessToken === 'Sample Head1' ||
      this.accessToken === 'Sample Head2' ||
